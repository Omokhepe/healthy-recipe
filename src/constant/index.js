import {carrot, flash, search, } from '../assets/icons';
import { mediterranean_chickpeas_large, avocado_toast_large, salmon_asparagus_large,
    quinoa_veggie_large, potato_tacos_large, greek_yoghurt_large,
    lentil_soup_large, banana_pancake_large} from '../assets/images';
...
export const featureInfo = [
    {subtitle: "Whole-food recipes", featText: "Each dish uses everyday, unprocessed ingredients.", icon: carrot},
    {subtitle: "Minimum fuss", featText: "All recipes are designed to make eating healthy quick and easy.", icon: flash},
    {subtitle: "Search in seconds", featText: "Filter by name or ingredient and jump straight to the recipe you need.", icon: search},
];

// export const PrepTime = Object.freeze({
//     minMin: 0,
//     medMin: 5,
//     maxMin: 10,
// });
...
export const prepTime =[
    {time: 0, text: '0 minute', isCookTime: false},
    {time: 5, text: '5 minutes', isCookTime: false},
    {time: 10, text: '10 minutes', isCookTime: false},
    {time: 15, text: '15 minutes', isCookTime: true},
    {time: 20, text: '20 minutes', isCookTime: true},
]
...
export const recipes = [
    {
        ...
        image: {
            large: mediterranean_chickpeas_large,
